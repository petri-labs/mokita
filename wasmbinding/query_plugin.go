...
func CustomQuerier(qp *QueryPlugin) func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
	return func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
		...
		case contractQuery.FullDenom != nil:
			...
			if err != nil {
				return nil, sdkerrors.Wrap(err, "moki full denom query")
			}
			...
			if err != nil {
				return nil, sdkerrors.Wrap(err, "moki full denom query response")
			}
		...
		case contractQuery.PoolState != nil:
			...
			if err != nil {
				return nil, sdkerrors.Wrap(err, "moki pool state query")
			}
			...
			bz, err := json.Marshal(res)
			if err != nil {
				return nil, sdkerrors.Wrap(err, "moki pool state query response")
			}
		...
		case contractQuery.SpotPrice != nil:
			...
			if err != nil {
				return nil, sdkerrors.Wrap(err, "moki spot price query")
			}

			res := bindings.SpotPriceResponse{Price: spotPrice.String()}
			bz, err := json.Marshal(res)
			if err != nil {
				return nil, sdkerrors.Wrap(err, "moki spot price query response")
			}
		...
		case contractQuery.EstimateSwap != nil:
			...
			if err != nil {
				return nil, sdkerrors.Wrap(err, "moki estimate swap query")
			}

			res := bindings.EstimatePriceResponse{Amount: *swapAmount}
			bz, err := json.Marshal(res)
			if err != nil {
				return nil, sdkerrors.Wrap(err, "moki estimate swap query response")
			}

			return bz, nil

		default:
			return nil, wasmvmtypes.UnsupportedRequest{Kind: "unknown mokita query variant"}
		}
	}
}
