...
func TestPoolState(t *testing.T) {
	...
	queryPlugin := wasmbinding.NewQueryPlugin(mokita.GAMMKeeper, mokita.TwapKeeper, mokita.TokenFactoryKeeper)
...
func TestSpotPrice(t *testing.T) {
	...
	starPrice := sdk.MustNewDecFromStr(fmt.Sprintf("%f", umoki/ustar))
