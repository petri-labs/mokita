...
// source: mokita/concentrated-liquidity/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreatePosition)(nil), "mokita.concentratedliquidity.v1beta1.MsgCreatePosition")
	proto.RegisterType((*MsgCreatePositionResponse)(nil), "mokita.concentratedliquidity.v1beta1.MsgCreatePositionResponse")
	proto.RegisterType((*MsgWithdrawPosition)(nil), "mokita.concentratedliquidity.v1beta1.MsgWithdrawPosition")
	proto.RegisterType((*MsgWithdrawPositionResponse)(nil), "mokita.concentratedliquidity.v1beta1.MsgWithdrawPositionResponse")
}

func init() {
	proto.RegisterFile("mokita/concentrated-liquidity/tx.proto", fileDescriptor_1f1fff802923d7db)
}
...
func (c *msgClient) CreatePosition(ctx context.Context, in *MsgCreatePosition, opts ...grpc.CallOption) (*MsgCreatePositionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mokita.concentratedliquidity.v1beta1.Msg/CreatePosition", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WithdrawPosition(ctx context.Context, in *MsgWithdrawPosition, opts ...grpc.CallOption) (*MsgWithdrawPositionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mokita.concentratedliquidity.v1beta1.Msg/WithdrawPosition", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePosition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mokita.concentratedliquidity.v1beta1.Msg/CreatePosition",
	}
...
func _Msg_WithdrawPosition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mokita.concentratedliquidity.v1beta1.Msg/WithdrawPosition",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mokita.concentratedliquidity.v1beta1.Msg",
	...
	Metadata: "mokita/concentrated-liquidity/tx.proto",
}
