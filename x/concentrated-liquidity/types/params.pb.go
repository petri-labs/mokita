...
// source: mokita/concentrated-liquidity/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "mokita.concentratedliquidity.Params")
}

func init() {
	proto.RegisterFile("mokita/concentrated-liquidity/params.proto", fileDescriptor_cd3784445b6f6ba7)
}
