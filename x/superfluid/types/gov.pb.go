...
// source: mokita/superfluid/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*SetSuperfluidAssetsProposal)(nil), "mokita.superfluid.v1beta1.SetSuperfluidAssetsProposal")
	proto.RegisterType((*RemoveSuperfluidAssetsProposal)(nil), "mokita.superfluid.v1beta1.RemoveSuperfluidAssetsProposal")
	proto.RegisterType((*UpdateUnpoolWhiteListProposal)(nil), "mokita.superfluid.v1beta1.UpdateUnpoolWhiteListProposal")
}

func init() {
	proto.RegisterFile("mokita/superfluid/v1beta1/gov.proto", fileDescriptor_2e37d6a8d0e42294)
}
