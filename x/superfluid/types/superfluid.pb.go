...
// source: mokita/superfluid/superfluid.proto
...
type SuperfluidAsset struct {
	...
	// share
	AssetType SuperfluidAssetType `protobuf:"varint,2,opt,name=asset_type,json=assetType,proto3,enum=mokita.superfluid.SuperfluidAssetType" json:"asset_type,omitempty"`
}
...
// and MOKI tokens for superfluid staking. The intermediary account is the
...
// The Moki-Equivalent-Multiplier Record for epoch N refers to the moki worth we
// treat an LP share as having, for all of epoch N. Eventually this is intended
// to be set as the Time-weighted-average-moki-backing for the entire duration
// of epoch N-1. (Thereby locking whats in use for epoch N as based on the prior
// epochs rewards) However for now, this is not the TWAP but instead the spot
// price at the boundary. For different types of assets in the future, it could
// change.
type MokiEquivalentMultiplierRecord struct {
...
func (m *MokiEquivalentMultiplierRecord) Reset()         { *m = MokiEquivalentMultiplierRecord{} }
func (m *MokiEquivalentMultiplierRecord) String() string { return proto.CompactTextString(m) }
func (*MokiEquivalentMultiplierRecord) ProtoMessage()    {}
func (*MokiEquivalentMultiplierRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_79d3c29d82dbb734, []int{2}
}
func (m *MokiEquivalentMultiplierRecord) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MokiEquivalentMultiplierRecord) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MokiEquivalentMultiplierRecord.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MokiEquivalentMultiplierRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MokiEquivalentMultiplierRecord.Merge(m, src)
}
func (m *MokiEquivalentMultiplierRecord) XXX_Size() int {
	return m.Size()
}
func (m *MokiEquivalentMultiplierRecord) XXX_DiscardUnknown() {
	xxx_messageInfo_MokiEquivalentMultiplierRecord.DiscardUnknown(m)
}

var xxx_messageInfo_MokiEquivalentMultiplierRecord proto.InternalMessageInfo

func (m *MokiEquivalentMultiplierRecord) GetEpochNumber() int64 {
	if m != nil {
...
func (m *MokiEquivalentMultiplierRecord) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func init() {
	proto.RegisterEnum("mokita.superfluid.SuperfluidAssetType", SuperfluidAssetType_name, SuperfluidAssetType_value)
	proto.RegisterType((*SuperfluidAsset)(nil), "mokita.superfluid.SuperfluidAsset")
	proto.RegisterType((*SuperfluidIntermediaryAccount)(nil), "mokita.superfluid.SuperfluidIntermediaryAccount")
	proto.RegisterType((*MokiEquivalentMultiplierRecord)(nil), "mokita.superfluid.MokiEquivalentMultiplierRecord")
	proto.RegisterType((*SuperfluidDelegationRecord)(nil), "mokita.superfluid.SuperfluidDelegationRecord")
	proto.RegisterType((*LockIdIntermediaryAccountConnection)(nil), "mokita.superfluid.LockIdIntermediaryAccountConnection")
	proto.RegisterType((*UnpoolWhitelistedPools)(nil), "mokita.superfluid.UnpoolWhitelistedPools")
}

func init() {
	proto.RegisterFile("mokita/superfluid/superfluid.proto", fileDescriptor_79d3c29d82dbb734)
}
...
func (m *MokiEquivalentMultiplierRecord) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MokiEquivalentMultiplierRecord) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MokiEquivalentMultiplierRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MokiEquivalentMultiplierRecord) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MokiEquivalentMultiplierRecord) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MokiEquivalentMultiplierRecord: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MokiEquivalentMultiplierRecord: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
