...
// source: mokita/superfluid/params.proto
...
type Params struct {
	// minimum_risk_factor is to be cut on MOKI equivalent value of lp tokens for
...
func init() {
	proto.RegisterType((*Params)(nil), "mokita.superfluid.Params")
}

func init() { proto.RegisterFile("mokita/superfluid/params.proto", fileDescriptor_0985261dfaf2a82e) }
