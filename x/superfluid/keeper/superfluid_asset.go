...
// See https://github.com/petri-labs/mokita/issues/864
...
func (k Keeper) GetRiskAdjustedMokiValue(ctx sdk.Context, asset types.SuperfluidAsset, amount sdk.Int) sdk.Int {
...
func (k Keeper) UnriskAdjustMokiValue(ctx sdk.Context, amount sdk.Dec) sdk.Dec {
	minRiskFactor := k.GetParams(ctx).MinimumRiskFactor
