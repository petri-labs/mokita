...
// E.g. if pool 1 trades 2 atom for 3 moki, the quote asset was atom, and the base asset was moki,
...
// by looking at the ratio of the total LP'd assets. (e.g. 2 moki : 1 atom)
