...
// source: mokita/gamm/v2/query.proto
...
import (
	...
	_ "github.com/tessornetwork/mokita/x/gamm/types"
...
func init() {
	proto.RegisterType((*QuerySpotPriceRequest)(nil), "mokita.gamm.v2.QuerySpotPriceRequest")
	proto.RegisterType((*QuerySpotPriceResponse)(nil), "mokita.gamm.v2.QuerySpotPriceResponse")
}

func init() { proto.RegisterFile("mokita/gamm/v2/query.proto", fileDescriptor_49ff000e88fc374c) }
...
var fileDescriptor_49ff000e88fc374c = []byte{
	...
	0x5d, 0x15, 0x27, 0xb4, 0xeb, 0xc9, 0x9b, 0x45, 0x41, 0x41, 0x44, 0xc7, 0x9b, 0x97, 0x21, 0xd3,
	...
	,
}
...
func (c *queryClient) SpotPrice(ctx context.Context, in *QuerySpotPriceRequest, opts ...grpc.CallOption) (*QuerySpotPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mokita.gamm.v2.Query/SpotPrice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_SpotPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mokita.gamm.v2.Query/SpotPrice",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mokita.gamm.v2.Query",
	...
	Metadata: "mokita/gamm/v2/query.proto",
}
