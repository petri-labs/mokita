...
var (
	...
	defaultMokiPoolAsset = balancer.PoolAsset{
		Token:  sdk.NewCoin("umoki", oneTrillion),
...
var calcSingleAssetJoinTestCases = []calcJoinSharesTestCase{
	...
	},
	{
		...
		//	A_t = amount of deposited asset = 50,000
		//	B_t = existing balance of deposited asset in the pool prior to deposit = 1,000,000,000,000
		//	W_t = normalized weight of deposited asset in pool = 0.25 (asset A, umoki, has weight 1/4 of uatom)
		// 	swapFeeRatio = (1 - (1 - W_t) * swapFee)
		// Plugging all of this in, we get:
	...
	},
	{
		...
		poolAssets: []balancer.PoolAsset{
			{
				Token:  sdk.NewInt64Coin("umoki", 156_736),
				Weight: sdk.NewInt(200),
			},
			{
				Token:  sdk.NewInt64Coin("uatom", 1e12),
		...
		// 156_736 * 3 / 4 = 117552
		tokensIn:     sdk.NewCoins(sdk.NewInt64Coin("umoki", (156_736*3)/4)),
	...
	},
	{
		...
		// 156_736 / 4 * 3 = 117552
		tokensIn:     sdk.NewCoins(sdk.NewInt64Coin("umoki", 156_736/4*3)),
	...
	},
	{
		...
		poolAssets: []balancer.PoolAsset{
			{
				Token:  sdk.NewInt64Coin("umoki", 500_000),
				Weight: sdk.NewInt(100),
			},
			{
				Token:  sdk.NewInt64Coin("uatom", 1e12),
		...
		tokensIn:     sdk.NewCoins(sdk.NewInt64Coin("umoki", 499_999)),
	...
	},
	{
		...
		tokensIn:     sdk.NewCoins(sdk.NewInt64Coin("umoki", 500_000)),
		expectShares: sdk.NewIntFromUint64(6_504_099_261_800_144_638),
		expectPanic:  true,
	},
	{
	...
	},
	{
		...
		poolAssets: []balancer.PoolAsset{
			{
				Token:  sdk.NewInt64Coin("umoki", 1_000_000_000_000),
				Weight: sdk.NewInt(100),
			},
			{
	...
	},
	{
		...
		poolAssets: []balancer.PoolAsset{
			{
				Token:  sdk.NewInt64Coin("umoki", 10_000_000_000_000),
				Weight: sdk.NewInt(100),
			},
			{
				Token:  sdk.NewInt64Coin("uatom", 1_000_000_000_000),
...
var multiAssetExactInputTestCases = []calcJoinSharesTestCase{
	...
	},
	{
		...
		poolAssets: []balancer.PoolAsset{
			{
				Token:  sdk.NewInt64Coin("umoki", 1),
				Weight: sdk.NewInt(100),
			},
			{
...
var multiAssetUnevenInputTestCases = []calcJoinSharesTestCase{
	{
		// For umokis and uatom
		// join pool is first done to the extent where the ratio can be preserved, which is 25,000 umoki and 25,000 uatom
	...
	{
		// join pool is first done to the extent where the ratio can be preserved, which is 25,000 umoki and 12,500 uatom.
		...
		poolAssets: []balancer.PoolAsset{
			{
				Token:  sdk.NewInt64Coin("umoki", 2_000_000_000_000),
				Weight: sdk.NewInt(500),
			},
			defaultAtomPoolAsset,
		},
...
func (suite *KeeperTestSuite) TestJoinPoolNoSwap() {
	...
	testCases := []calcJoinSharesTestCase{
		...
		},
		{
			...
			// Since only the exact ratio portion is successfully joined, we expect 25k umoki and 12.5k uatom
			name:    "Multi-tokens In: unequal amounts, with unequal weights with 0.03 swap fee",
			swapFee: sdk.MustNewDecFromStr("0.03"),
			poolAssets: []balancer.PoolAsset{
				{
