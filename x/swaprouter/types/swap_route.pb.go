...
// source: mokita/swaprouter/v1beta1/swap_route.proto
...
func init() {
	proto.RegisterType((*SwapAmountInRoute)(nil), "mokita.swaprouter.v1beta1.SwapAmountInRoute")
	proto.RegisterType((*SwapAmountOutRoute)(nil), "mokita.swaprouter.v1beta1.SwapAmountOutRoute")
}

func init() {
	proto.RegisterFile("mokita/swaprouter/v1beta1/swap_route.proto", fileDescriptor_9eda4cafb53adf83)
}
