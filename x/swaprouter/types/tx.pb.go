...
// source: mokita/swaprouter/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgSwapExactAmountIn)(nil), "mokita.swaprouter.v1beta1.MsgSwapExactAmountIn")
	proto.RegisterType((*MsgSwapExactAmountInResponse)(nil), "mokita.swaprouter.v1beta1.MsgSwapExactAmountInResponse")
	proto.RegisterType((*MsgSwapExactAmountOut)(nil), "mokita.swaprouter.v1beta1.MsgSwapExactAmountOut")
	proto.RegisterType((*MsgSwapExactAmountOutResponse)(nil), "mokita.swaprouter.v1beta1.MsgSwapExactAmountOutResponse")
}

func init() {
	proto.RegisterFile("mokita/swaprouter/v1beta1/tx.proto", fileDescriptor_05a4da63b1afc25d)
}
...
func (c *msgClient) SwapExactAmountIn(ctx context.Context, in *MsgSwapExactAmountIn, opts ...grpc.CallOption) (*MsgSwapExactAmountInResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mokita.swaprouter.v1beta1.Msg/SwapExactAmountIn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SwapExactAmountOut(ctx context.Context, in *MsgSwapExactAmountOut, opts ...grpc.CallOption) (*MsgSwapExactAmountOutResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mokita.swaprouter.v1beta1.Msg/SwapExactAmountOut", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SwapExactAmountIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mokita.swaprouter.v1beta1.Msg/SwapExactAmountIn",
	}
...
func _Msg_SwapExactAmountOut_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mokita.swaprouter.v1beta1.Msg/SwapExactAmountOut",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mokita.swaprouter.v1beta1.Msg",
	...
	Metadata: "mokita/swaprouter/v1beta1/tx.proto",
}
