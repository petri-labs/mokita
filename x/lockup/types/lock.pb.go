...
// source: mokita/lockup/lock.proto
...
type QueryCondition struct {
	...
	LockQueryType LockQueryType `protobuf:"varint,1,opt,name=lock_query_type,json=lockQueryType,proto3,enum=mokita.lockup.LockQueryType" json:"lock_query_type,omitempty"`
...
func init() {
	proto.RegisterEnum("mokita.lockup.LockQueryType", LockQueryType_name, LockQueryType_value)
	proto.RegisterType((*PeriodLock)(nil), "mokita.lockup.PeriodLock")
	proto.RegisterType((*QueryCondition)(nil), "mokita.lockup.QueryCondition")
	proto.RegisterType((*SyntheticLock)(nil), "mokita.lockup.SyntheticLock")
}

func init() { proto.RegisterFile("mokita/lockup/lock.proto", fileDescriptor_7e9d7527a237b489) }
