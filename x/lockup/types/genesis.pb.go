...
// source: mokita/lockup/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "mokita.lockup.GenesisState")
}

func init() { proto.RegisterFile("mokita/lockup/genesis.proto", fileDescriptor_648db7c6ebb608b0) }
