...
// source: mokita/mint/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "mokita.mint.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("mokita/mint/v1beta1/genesis.proto", fileDescriptor_12e6a5511ad3feeb)
}
