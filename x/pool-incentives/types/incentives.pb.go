...
// source: mokita/pool-incentives/v1beta1/incentives.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "mokita.poolincentives.v1beta1.Params")
	proto.RegisterType((*LockableDurationsInfo)(nil), "mokita.poolincentives.v1beta1.LockableDurationsInfo")
	proto.RegisterType((*DistrInfo)(nil), "mokita.poolincentives.v1beta1.DistrInfo")
	proto.RegisterType((*DistrRecord)(nil), "mokita.poolincentives.v1beta1.DistrRecord")
	proto.RegisterType((*PoolToGauge)(nil), "mokita.poolincentives.v1beta1.PoolToGauge")
	proto.RegisterType((*PoolToGauges)(nil), "mokita.poolincentives.v1beta1.PoolToGauges")
}

func init() {
	proto.RegisterFile("mokita/pool-incentives/v1beta1/incentives.proto", fileDescriptor_a8153bad03e553d1)
}
