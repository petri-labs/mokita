...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&UpdatePoolIncentivesProposal{}, "mokita/UpdatePoolIncentivesProposal")
	govtypes.RegisterProposalType(ProposalTypeReplacePoolIncentives)
	govtypes.RegisterProposalTypeCodec(&ReplacePoolIncentivesProposal{}, "mokita/ReplacePoolIncentivesProposal")
}
