...
// TestEpochHook tests that the epoch hook is correctly setting the pool IDs for the moki and atom pools.
...
// have moki or atom as one of the assets. The pools are then filtered again to only include the pools that
