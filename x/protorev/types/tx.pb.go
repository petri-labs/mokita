...
// source: mokita/protorev/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgSetHotRoutes)(nil), "mokita.protorev.v1beta1.MsgSetHotRoutes")
	proto.RegisterType((*MsgSetHotRoutesResponse)(nil), "mokita.protorev.v1beta1.MsgSetHotRoutesResponse")
	proto.RegisterType((*MsgSetDeveloperAccount)(nil), "mokita.protorev.v1beta1.MsgSetDeveloperAccount")
	proto.RegisterType((*MsgSetDeveloperAccountResponse)(nil), "mokita.protorev.v1beta1.MsgSetDeveloperAccountResponse")
}

func init() { proto.RegisterFile("mokita/protorev/v1beta1/tx.proto", fileDescriptor_2783dce032fc6954) }
...
func (c *msgClient) SetHotRoutes(ctx context.Context, in *MsgSetHotRoutes, opts ...grpc.CallOption) (*MsgSetHotRoutesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mokita.protorev.v1beta1.Msg/SetHotRoutes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetDeveloperAccount(ctx context.Context, in *MsgSetDeveloperAccount, opts ...grpc.CallOption) (*MsgSetDeveloperAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mokita.protorev.v1beta1.Msg/SetDeveloperAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetHotRoutes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mokita.protorev.v1beta1.Msg/SetHotRoutes",
	}
...
func _Msg_SetDeveloperAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mokita.protorev.v1beta1.Msg/SetDeveloperAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mokita.protorev.v1beta1.Msg",
	...
	Metadata: "mokita/protorev/v1beta1/tx.proto",
}
