...
var (
	pattern_Msg_SetHotRoutes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"mokita", "v13", "protorev", "set_hot_routes"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_SetDeveloperAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"mokita", "v13", "protorev", "set_developer_account"}, "", runtime.AssumeColonVerbOpt(false)))
)
