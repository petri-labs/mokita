...
// source: mokita/incentives/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "mokita.incentives.GenesisState")
}

func init() { proto.RegisterFile("mokita/incentives/genesis.proto", fileDescriptor_a288ccc95d977d2d) }
