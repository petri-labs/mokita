...
// source: mokita/downtime-detector/v1beta1/downtime_duration.proto
...
func init() {
	proto.RegisterEnum("mokita.downtimedetector.v1beta1.Downtime", Downtime_name, Downtime_value)
}

func init() {
	proto.RegisterFile("mokita/downtime-detector/v1beta1/downtime_duration.proto", fileDescriptor_21a1969f22fb2a7e)
}
