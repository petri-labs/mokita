...
// source: mokita/downtime-detector/v1beta1/query.proto
...
import (
	...
	types "github.com/petri-labs/mokita/x/downtime-detector/types"
...
type RecoveredSinceDowntimeOfLengthRequest struct {
	Downtime types.Downtime `protobuf:"varint,1,opt,name=downtime,proto3,enum=mokita.downtimedetector.v1beta1.Downtime" json:"downtime,omitempty" yaml:"downtime"`
...
func init() {
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthRequest)(nil), "mokita.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest")
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthResponse)(nil), "mokita.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse")
}

func init() {
	proto.RegisterFile("mokita/downtime-detector/v1beta1/query.proto", fileDescriptor_b748b3d07fa8b8cb)
}
...
var fileDescriptor_b748b3d07fa8b8cb = []byte{
	...
	,
}
...
func (c *queryClient) RecoveredSinceDowntimeOfLength(ctx context.Context, in *RecoveredSinceDowntimeOfLengthRequest, opts ...grpc.CallOption) (*RecoveredSinceDowntimeOfLengthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mokita.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_RecoveredSinceDowntimeOfLength_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mokita.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mokita.downtimedetector.v1beta1.Query",
	...
	Metadata: "mokita/downtime-detector/v1beta1/query.proto",
}
