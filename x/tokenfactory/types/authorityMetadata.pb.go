...
// source: mokita/tokenfactory/v1beta1/authorityMetadata.proto
...
type DenomAuthorityMetadata struct {
	// Can be empty for no admin, or a valid mokita address
...
func init() {
	proto.RegisterType((*DenomAuthorityMetadata)(nil), "mokita.tokenfactory.v1beta1.DenomAuthorityMetadata")
}

func init() {
	proto.RegisterFile("mokita/tokenfactory/v1beta1/authorityMetadata.proto", fileDescriptor_99435de88ae175f7)
}
