...
// source: mokita/txfees/v1beta1/feetoken.proto
...
func init() {
	proto.RegisterType((*FeeToken)(nil), "mokita.txfees.v1beta1.FeeToken")
}

func init() {
	proto.RegisterFile("mokita/txfees/v1beta1/feetoken.proto", fileDescriptor_c50689857adfcfe0)
}
