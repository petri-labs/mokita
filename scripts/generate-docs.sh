...
yq -i '."servers"+=[{"url":"https://lcd.mokita.zone","description":"Mokita mainnet node"},{"url":"https://lcd-test.mokita.zone","description":"Mokita testnet node"}]' static/openapi/openapi.yaml
