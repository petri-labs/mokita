...
* [#3647](https://github.com/osmosis-labs/osmosis/pull/3647), [3942](https://github.com/osmosis-labs/osmosis/pull/3942) (CLI) re-order the command line arguments for `mokitad tx gamm join-swap-share-amount-out`
...
* [#2956](https://github.com/tessornetwork/mokita/issues/2956) Add queries for calculating amount of shares/tokens you get by providing X tokens/shares when entering/exiting a pool
...
* [#2193](https://github.com/osmosis-labs/osmosis/pull/2193) Add TwapKeeper to the Mokita app
...
* [#2587](https://github.com/osmosis-labs/osmosis/pull/2587) remove encoding config argument from NewMokitaApp
x
...
#### SDK Upgrades
* [#2245](https://github.com/osmosis-labs/osmosis/pull/2245) Upgrade SDK for to v0.45.0x-moki-v9.2. Major changes:
...
#### SDK Upgrades
* [#2146](https://github.com/osmosis-labs/osmosis/pull/2146) Upgrade SDK for to v0.45.0x-moki-v9.1. Major changes:
...
## [v9.0.0 - Nitrogen](https://github.com/tessornetwork/mokita/releases/tag/v9.0.0)
...
Integrators will have to update their messages and queries to adapt, please see https://github.com/tessornetwork/mokita/blob/main/x/gamm/breaking_changes_notes.md
...
* [#1564](https://github.com/osmosis-labs/osmosis/pull/1564) Enable Interchain account host module
  * See [here](https://github.com/tessornetwork/mokita/blob/main/app/upgrades/v9/upgrades.go#L49-L71) for the supported messages

#### Txfees

[#1145](https://github.com/osmosis-labs/osmosis/pull/1145) Non-moki txfees now get swapped into moki everyday at epoch, and then distributed to stakers.
...
* [#1640](https://github.com/osmosis-labs/osmosis/pull/1640) fix: localmokita to work for testing cosmwasm contracts
...
* [#1535](https://github.com/osmosis-labs/osmosis/pull/1535) upgrade wasmd to v0.27.0.rc3-moki and ibc-go to v3
  * State sync now works for cosmwasm state
  * Cosmwasm builds on M1 macs
...
* [#1632](https://github.com/osmosis-labs/osmosis/pull/1632) augment SuperfluidDelegationsByDelegator query, return moki equivilent is staked via superfluid
* [#1723](https://github.com/osmosis-labs/osmosis/pull/1723) fix number of LP shares returned from stableswap pool

## [v8.0.0 - Emergency proposals upgrade](https://github.com/tessornetwork/mokita/releases/tag/v8.0.0)
...
* [#1105](https://github.com/osmosis-labs/osmosis/pull/1105) Add GitHub Actions to automatically push the mokita Docker image
...
## [v7.1.0](https://github.com/tessornetwork/mokita/releases/tag/v7.1.0)
...
## [v7.0.4](https://github.com/tessornetwork/mokita/releases/tag/v7.0.4)

### Minor improvements & Bug Fixes

* [#1061](https://github.com/osmosis-labs/osmosis/pull/1061) upgrade iavl to v0.17.3-moki-v5 with concurrent map write fix
...
## [v7.0.3](https://github.com/tessornetwork/mokita/releases/tag/v7.0.3)

### Minor improvements & Bug Fixes

* [#1022](https://github.com/osmosis-labs/osmosis/pull/1022) upgrade iavl to v0.17.3-moki-v4 - fix state export at an old height
...
## [v7.0.2 - Carbon](https://github.com/tessornetwork/mokita/releases/tag/v7.0.2)
...
## [v7.0.0 - Carbon](https://github.com/tessornetwork/mokita/releases/tag/v7.0.0)
...
Upgrade instructions for node operators can be found [here](https://github.com/tessornetwork/mokita/blob/main/networks/mokita-1/upgrades/v7/guide.md)
...
* [#804](https://github.com/osmosis-labs/osmosis/pull/804/) Make the Mokita repo use proper golang module versioning in self-package imports. (Enables other go projects to easily import Mokita tags)
...
* [#680](https://github.com/osmosis-labs/osmosis/pull/680/),[#697](https://github.com/osmosis-labs/osmosis/pull/697/) Change app.go file structure to mitigate risk of keeper reference vs keeper struct bugs. (What caused Mokita v5 -> v6)

### Minor improvements & Bug Fixes

* [#924](https://github.com/osmosis-labs/osmosis/pull/923) Fix long standing problems with total supply query over-reporting the number of moki.
...
## [v6.4.0](https://github.com/tessornetwork/mokita/releases/tag/v6.4.0)
...
## [v6.3.1](https://github.com/tessornetwork/mokita/releases/tag/v6.3.1)

* [#859](https://github.com/osmosis-labs/osmosis/pull/859) CLI, update default durations to be in better units.

* [#Unknown](https://github.com/tessornetwork/mokita/commit/3bf63f1d3b7efee503106a008e84129489bdba8d) Switch to SDK branch with vesting by duration
...
## [v6.3.0](https://github.com/tessornetwork/mokita/releases/tag/v6.3.0)
...
## [v6.2.0](https://github.com/tessornetwork/mokita/releases/tag/v6.2.0)
...
## [v6.1.0](https://github.com/tessornetwork/mokita/releases/tag/v6.1.0)
...
* [#722](https://github.com/tessornetwork/mokita/issues/722) reuse code for parsing integer slices from string
* [#704](https://github.com/osmosis-labs/osmosis/pull/704) fix rocksdb
* [#666](https://github.com/osmosis-labs/osmosis/pull/666) Fix the `--log-level` and `--log-format` commands on `mokitad start`
* [#655](https://github.com/osmosis-labs/osmosis/pull/655) Make the default genesis for pool-incentives work by default
* [97ac2a8](https://github.com/tessornetwork/mokita/commit/97ac2a86303fc8966a4c169107e0945775107e67) Fix InitGenesis bug for gauges
...
## [v6.0.0](https://github.com/tessornetwork/mokita/releases/tag/v6.0.0)
...
* [Patch](https://github.com/tessornetwork/mokita/commit/907001b08686ed980e0afa3d97a9c5e2f095b79f#diff-a172cedcae47474b615c54d510a5d84a8dea3032e958587430b413538be3f333) - Revert back to passing in the correct staking keeper into the IBC keeper constructor.
...
## [v5.0.0](https://github.com/tessornetwork/mokita/releases/tag/v5.0.0) - Boron upgrade
...
* Bringing in the new modules [Bech32IBC](https://github.com/osmosis-labs/bech32-ibc/), [Authz](https://github.com/cosmos/cosmos-sdk/tree/master/x/authz/spec), [TxFees](https://github.com/tessornetwork/mokita/tree/main/x/txfees)
...
Upgrade instructions for node operators can be found [here](https://github.com/tessornetwork/mokita/blob/v5.x/networks/mokita-1/upgrades/v5/guide.md)
...
* [\#560](https://github.com/osmosis-labs/osmosis/pull/560) Implements Mokita [prop32](https://www.mintscan.io/mokita/proposals/32) -- clawing back the final 20% of unclaimed moki and ion airdrop.
* [\#394](https://github.com/osmosis-labs/osmosis/pull/394) Allow whitelisted tx fee tokens based on conversion rate to MOKI
* [Commit db450f0](https://github.com/tessornetwork/mokita/commit/db450f0dce8c595211d920f9bca7ed0f3a136e43) Add blocking of OFAC banned Ethereum addresses
...
## [v3.2.0](https://github.com/mokita/osmosis-labs/releases/tag/v2.0.0) - 2021-06-28
...
## [v1.0.2](https://github.com/mokita/osmosis-labs/releases/tag/v1.0.2) - 2021-06-18

This release improves the CLI UX of creating and querying gauges.

## [v1.0.1](https://github.com/mokita/osmosis-labs/releases/tag/v1.0.1) - 2021-06-17

This release fixes a bug in `mokitad version` always displaying 0.0.1.

## [v1.0.0](https://github.com/mokita/osmosis-labs/releases/tag/v1.0.0) - 2021-06-16
